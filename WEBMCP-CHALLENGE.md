...
The steps are defined once, in `ToolsController::STEPS`. This table mirrors
them, and [a test](test/webmcp_challenge_test.rb) fails if the two drift apart.

| # | Ask | What should happen | Tool |
|---|---|---|---|
| 1 | *"Tell me what tools this site gives you."* | Eight tools on the homepage: four read the record, four work on the page. | discovery |
